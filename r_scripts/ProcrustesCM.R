...
json <- list(objects_name = rownames(result['data'][[1]][0]),data = dataset, number_of_objects = n_spec, number_of_landmarks = n_land , dimention = n_dim,consensus =  result[['consensus']] )
